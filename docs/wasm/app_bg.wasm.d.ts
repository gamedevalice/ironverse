...
export function wasm_bindgen__convert__closures__invoke0_mut__h3f4cf7dc6a72b6e8(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0233b081292037ec(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h4fce3da0ac7a8772(a: number, b: number, c: number, d: number): void;
