...
export function wasm_bindgen__convert__closures__invoke1_mut__hb129cd4ba7dcf257(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h60950c29ae45f832(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h1695fa9a70a6acb1(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h6a3722367ac58a72(a: number, b: number, c: number, d: number): void;
